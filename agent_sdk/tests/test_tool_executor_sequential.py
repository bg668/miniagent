...
from ..runtime.config import AfterToolCallResult, AgentLoopConfig, BeforeToolCallResult
...
from ..runtime.tool_executor import execute_tool_calls
...
def test_tool_executor_sequential_full_chain_and_error_collection():
    async def _run() -> None:
        ...
        async def after_tool_call(context, cancel_token):
            call_log.append(("after", context.tool_call.id, context.is_error))
